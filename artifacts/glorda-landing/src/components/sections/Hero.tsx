  ...
  return (
    <div className="relative w-[260px] h-[520px] mx-auto">
      ...
      <div className="relative w-full h-full bg-[#111] rounded-[2.8rem] shadow-2xl overflow-hidden border-[3px] border-white/20">
        ...
        <img src={screenHome} alt="Glorda App" className="w-full h-full object-cover object-top" />
        <div className="absolute inset-0 bg-gradient-to-br from-white/10 via-transparent to-transparent pointer-events-none" />
      </div>

      {/* Floating badge — location (inline-end side = right in RTL, left in LTR) */}
      <motion.div
        animate={{ y: [-5, 5, -5] }}
        transition={{ duration: 4, repeat: Infinity, ease: "easeInOut", delay: 0.5 }}
        className="absolute top-8 -end-14 bg-white rounded-2xl px-3 py-2 shadow-xl border border-gray-100 flex items-center gap-2 z-20"
      >
      ...
      <motion.div
        ...
        className="absolute bottom-24 -end-12 bg-primary rounded-2xl px-3 py-2 shadow-xl flex items-center gap-2 z-20"
      >
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-primary">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 py-20 w-full">
        {/* Two-column — direction-aware: text at inline-start, phone at inline-end */}
