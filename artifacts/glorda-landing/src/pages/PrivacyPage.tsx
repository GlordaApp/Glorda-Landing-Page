...
const sectionsAr: Section[] = [
  {
    title: "مقدمة",
    intro: "تقدّم هذه السياسة شرحًا لكيفية جمع واستخدام وحماية بيانات المستخدمين في تطبيق غلوردا، المملوك لـ شركة أعماق السوق للتجارة، والمسجلة في وزارة التجارة السعودية برقم 7052888539، وموثقة في منصة التجارة الإلكترونية برقم 0000209355.",
