...
const translations = {
  ...
  ar: {
    ...
    "about.operator.desc": "يُدار التطبيق ويُشغَّل بواسطة مؤسسة علي لافي الحسناني، المسجلة رسميًا في وزارة التجارة السعودية برقم 7052888539، وموثقة في منصة التجارة الإلكترونية برقم 0000209355.",
